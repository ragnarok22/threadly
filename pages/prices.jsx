      ...
      <div className="xl:mx-auto xl:container py-8 2xl:px-0 px-6">
        <div className="lg:flex items-center justify-between">
          <div className=" lg:w-1/2 w-full">
            <p className="text-base leading-4 text-gray-600 dark:text-gray-300">Elige un plan que se ajuste a ti</p>
            ...
            Comienza a gestionar tu contenido en Twitter de una forma fácil y sencilla. Trabajamos para que puedas mejorar tu contenido en Twitter
            </p>
            <div className="w-56">
          ...
          <div className="xl:w-1/2 lg:w-7/12 relative w-full lg:mt-0 mt-12 md:px-8" role="list">
            ...
            <div role="listitem" className="bg-white dark:bg-gray-600 shadow rounded-lg p-8 relative z-30">
              <div className="md:flex items-center justify-between">
                ...
                <p className="text-2xl font-semibold md:mt-0 mt-4 leading-6 text-gray-800 dark:text-gray-100">GRATIS</p>
              </div>
